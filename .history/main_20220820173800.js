...
Security
Insights
jsissuetracker/main.js /
@seeschweiler
seeschweiler first commit
Latest commit 9e02c3f on Jan 28, 2017
 History
 1 contributor
86 lines (68 sloc)  2.61 KB
...
//     localStorage.setItem('issues', JSON.stringify(issues));   /* rewrite result to storage */
//     fetchIssues();
// }
...
//                                                 '<p><span class="glyphicon glyphicon-time"></span>' + severity + '</p>' +
//                                                 '<p><span class="glyphicon glyphicon-user"></span>' + assignedTo + '</p>' +
//                                                 // add buttons (be careful with quotes spacing)
//                                                 '<a href="#" onclick="setStatusClosed(\''+id+'\')" class="btn btn-warning">Close</a>' +
//                                                 '<a href="#" onclick="deleteIssue(\' '+id+ '\')" class="btn btn-danger">Delete</a>' +
