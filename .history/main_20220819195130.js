...
// function stores available issuesList
function saveIssue(e) {
    ...
    //  check if there are items in the local storage, if not, push issue object into the issue array defined in the if statement
    //else insert new object by retrieving items in local storage into issues array and send it back to the local storage
